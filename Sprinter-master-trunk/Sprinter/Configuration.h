...
// X, Y, Z, E steps per unit - Zaber LSM Product
#define _AXIS_STEP_PER_UNIT (5354.32, 5354.32, 5354.32, 5354.32)
...
#define _MAX_FEEDRATE {200, 200, 200, 45}       // (mm/sec)    
